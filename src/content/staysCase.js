...
export const staysCase = {
  ...
  // The Stays booking flow (end-to-end product context).
  bookingFlow: {
    kicker: 'The product',
    title: 'The Stays booking flow',
    body: 'The end-to-end journey — from browsing to a confirmed booking.',
    steps: [
      { label: 'Home', src: '/screens/case/flow-home.jpg' },
      { label: 'Hotel search', src: '/screens/case/flow-search.jpg' },
      { label: 'Hotel results', src: '/screens/case/flow-results.jpg' },
      { label: 'Details & Rooms', src: '/screens/case/flow-details.jpg' },
      { label: 'Guest details', src: '/screens/case/flow-guest.jpg' },
      { label: 'Confirm & pay', src: '/screens/case/flow-pay.jpg' },
    ],
  },

  // The old experience at the weakest step — hotel details & room selection.
  oldExperience: {
    kicker: 'Old experience',
    title: 'Hotel details and room selection',
    body: 'The most complex step in the funnel — where travelers validate the hotel and choose a room. Before proceeding, they need to confirm the location, what the hotel looks like, whether they can trust it, and which room is right for them. This is where the experience broke down.',
    steps: [
      { label: 'Hotel & rooms', src: '/screens/case/old-hotel.jpg' },
      { label: 'Hotel details', src: '/screens/case/old-details.jpg' },
      { label: 'Guest reviews', src: '/screens/case/old-reviews.jpg' },
      { label: 'Map & location', src: '/screens/case/old-map.jpg' },
      { label: 'Room options', src: '/screens/case/old-rooms.jpg' },
    ],
  },

  // Review card redesign — a separate solution detail (added after the main
  // solutions section, not part of it).
  reviewCard: {
    kicker: 'The solutions',
    title: 'Review card',
    body: 'The review card is where trust is won or lost. It was redesigned to make each review more credible and easier to read at a glance.',
    changes: [
      'Added nationality flags to help customers identify reviews from travelers with a similar cultural background.',
      'Added category ratings from each reviewer to provide more context on their experience.',
      'Replaced generic reviewer profile images with icons that reflect their rating.',
    ],
    cards: [
      { src: '/screens/case/revcard-before.jpg', label: 'Before' },
      { src: '/screens/case/revcard-flags.jpg', label: 'Nationality flag & rating icon' },
      { src: '/screens/case/revcard-ratings.jpg', label: 'Per-reviewer category ratings' },
    ],
  },
}
