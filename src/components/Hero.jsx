    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-container items-center gap-12 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="lg:col-span-7">
          <p className="reveal reveal-in mb-4 text-[13px] font-medium uppercase tracking-[0.2em] text-ink/50">
            {hero.tag}
          </p>
          <h1 className="text-balance text-[clamp(2.5rem,6vw,5rem)] font-semibold leading-[1] tracking-tightest text-ink">
            {hero.headline}
          </h1>
          <p className="mt-6 max-w-2xl text-pretty text-[clamp(1.05rem,1.4vw,1.3rem)] leading-relaxed text-ink/70">
            {hero.subline}
          </p>
